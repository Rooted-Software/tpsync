      ...
      <div className="bg-dark text-white lg:p-8">
        <div className="m-auto flex w-full max-w-xl flex-col justify-center space-y-6">
          <div className="flex flex-col space-y-2 text-center">
            ...
            <UniversalSelect title="Save and Continue" route={process.env.NEXT_PUBLIC_APP_URL +'/api/feAccounts'} method="GET" fields={['account_id', 'account_number', 'description', 'class']} subType='credit' selected={user?.team?.defaultCreditAccount} redirect='/step5' />
          </div>
        </div>
