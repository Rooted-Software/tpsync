...
async function upsertProject(project) { await db.feProjects.upsert({
    where: {
    ...
    update: {
      ...
      posting_date: project.posting_date ?  new Date(project.posting_date) : null,
      ...
      date_modified: project.date_modified ? new Date(project.date_modified): null,
