      ...
      <div className="bg-dark text-white lg:p-8">
        <div className="m-auto flex w-full max-w-xl flex-col justify-center space-y-6">
          <div className="flex flex-col space-y-2 text-center">
            ...
            <UniversalSelect title="Save and Continue" route="/api/feAccounts" method="GET" subType='debit' fields={['account_id', 'account_number', 'description', 'class']} selected={user?.defaultDebitAccount} redirect='/step4b' />
          </div>
        </div>
